package com.project.CollegeFest.Controller;
...
import com.project.CollegeFest.ServiceImpl.StudentService;
...
public class StudentController {
	...
	public String fetchStudentById(@RequestParam("studentId") int id, Model model) {
	...
	public String deleteStudentById(@RequestParam("id") int id) {
		...
		return "redirect:fetchAllStudents";
	}
